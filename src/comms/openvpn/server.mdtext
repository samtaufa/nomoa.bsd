...
<div style="float:right">
    <ol>
        ...
        <li> <a href="#createcertificates">Build our Certificates</a>
            <ol>
                <li> <a href="#createcertificates.cleanup">Prepping the environment, Cleaning Up</a></li>
                ...
                <li> <a href="#createcertificates.DH">Build the DH key</a></li>
            </ol></li>
        <li><a href="#server.config">Sample Configuration File</a>
            <ol>
                <li><a href="#server.config.modification">Example Modification</a></li>
                <li><a href="#server.server.config">Sample Server to Server Configuration</a></li>
            </ol></li>
        <li><a href="#server.interfaces">Configuring the interfaces</a></li>
        <li><a href="#server.start">Starting the Server</a></li>
        <li><a href="#server.firewall">Configuring the Firewall (PF)</a></li>
    </ol>
</div>
