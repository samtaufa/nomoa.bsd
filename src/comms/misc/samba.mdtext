...
Ambiguous: 
samba could be samba-3.0.37p1-cups-ldap samba-3.0.37p1 samba-3.0.37p1-ldap 
samba-3.0.37p1-cups samba-3.0.37p1-cups-ads samba-3.0.37p1-ads
</pre>
...
For our samba installation, the following packages display post-install
information, related to completing the configuration of the installed
package.
...
The displayed post-install information is also avaliable in the pkg db
repository as +DISPLAY, whilst +DESC is a short descripton of the 
installed package.

Post Package Install display, also available from: /var/db/pkg/avahi-0.6.25p5/+DISPLAY
...
But what is the avahi package ? cat /var/db/pkg/avahi-0.6.25p5/+DESC
...
Looks like something we want to configure, as specified earlier above.

Post Package Install display, also available from: /var/db/pkg/cups-1.3.11p6/+DISPLAY
...
But what is the cups package ? cat /var/db/pkg/cups-1.3.11p6/+DESC
...
Printing is always a useful event.  We want to configure, as specified earlier above.

Post Package Install display, also available from: /var/db/pkg/dbus-1.2.16p0/+DISPLAY
...
But what is the dbus package? cat /var/db/pkg/dbus-1.2.16p0/+DESC
...
What does that actually mean? Looks like something we want to configure, 
as specified earlier above.

Post Package Install display, also available from: 
/var/db/pkg/samba-3.0.37p1-cups/+DISPLAY
