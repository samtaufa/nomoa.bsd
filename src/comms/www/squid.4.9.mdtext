...
<ol>
  ...
  <ul>
	<li><a href="#squidEXport">Port to listen on</a></li>
	<li><a href="#squidEXsubnet">Network IPs to support</a></li>
	<li><a href="#squidEXTIME">Time intervals</a></li>
	<li><a href="#squidEXurl"> Organisational Policies</a></li>
	<li><a href="#squidEXcustomerrs">Informative Messages</a></li>
	<li><a href="#squidEXhttp_access">Configuring Access</a></li>
	  <li><a href="#squidEXdeny">Restricting Access</a></li>
	  <li><a href="#squidEXcache">Networks Access</a></li>
	  <li><a href="#squidEXTIMEbased">Restricting Access</a></li>
	  <li><a href="#squidEXdirect">Ignoring the cache</a> </li>
	<li><a href="#squidEXgo">Let's Go</a></li>
  </ul></li>
  <li><a href="#squidEX2">Extending The Sample</a>
  <ul>
	<li><a href="#squidEX2url">Restricted Sites</a></li>
	<li><a href="#squidEX2customerrs">Informative Messages</a></li>
	<li><a href="#squidEX2access">Access to the Cache</a>
	<ul>
	  <li><a href="#squidEX2deny">Restricting Access to External Sites</a></li>
	  <li><a href="#squidEX2cache">Allowing Specified networks</a></li>
	  <li><a href="#squidEX2TIMEbased">Internal Access</a></li>
	</ul></li>
  ...
  <ul>
	<li><a href="#squidMiscDNS">DNS Startup Test</a></li>
	<li><a href="#squidMiscDebug">Debug</a></li>
...
Squid 2.7 package is available with the CD set and later versions may be available 
on the NET. To install the package, use the pkg_add program as in the example 
below

<pre class="command-line">
# pkg_add /[path-to-package]/pkg_add squid-2.7.STABLE9p8-ldap-snmp
</pre>
...
Add a new line for the macro **"rc_scripts"** to add the rcscript specified
by the install *squid*. Or, add it to the list of existing scripts for
the macro.
...
Manually start squid by typing using the installed *squid* rcscript:
